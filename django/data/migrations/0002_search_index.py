...
def create_index(apps, schema_editor):
    migrations.RunSQL("ALTER TABLE variant ADD COLUMN fts_document TSVECTOR;")
    migrations.RunSQL("""
    ...
    CREATE TRIGGER variant_fts_insert_trigger BEFORE INSERT ON employee FOR EACH ROW EXECUTE PROCEDURE variant_fts_document_trigger();
    """)

    migrations.RunSQL("CREATE INDEX variant_fts_index ON variant USING gin(fts_document);")
