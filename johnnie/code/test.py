import config, utilities, snp_info

def test_make_toy():
  utilities.make_toy(input_fn, toy_output_fn, toy_percentage)

def test_extract_exon():
  utilities.extract_exon(input_fn, exon_output_fn)

def test_synthetic_dob():
  dobs = utilities.synthetic_dob(2504)
  assert len(dobs) == 2504, "Error in utilities.synthetic_dob()"
