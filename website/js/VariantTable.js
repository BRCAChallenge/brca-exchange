        ...
        innerGroups: [
            {
                ...
                chart: [
                    {title: 'Allele Frequency Charts (gnomAD Genomes)', prop: 'Allele_Frequency_Charts_Genome_GnomADv3', replace: alleleFrequencyCharts, tableKey: false, dummy: true},
                ],
                data: [
                    {title: 'Total Allele frequency', prop: 'Allele_frequency_genome_GnomADv3', core: true},
                    {title: 'Popmax Filtering Allele Frequency (95% confidence)', prop: 'faf95_popmax_genome_GnomADv3', core: true},
                    {title: 'Allele frequency African', prop: 'Allele_frequency_genome_AFR_GnomADv3', core: true},
                    {title: 'Allele frequency Latino', prop: 'Allele_frequency_genome_AMR_GnomADv3', core: true},
                    {title: 'Allele frequency Ashkenazi Jewish', prop: 'Allele_frequency_genome_ASJ_GnomADv3', core: true},
                    {title: 'Allele frequency East Asian', prop: 'Allele_frequency_genome_EAS_GnomADv3', core: true},
                    {title: 'Allele frequency Finnish', prop: 'Allele_frequency_genome_FIN_GnomADv3', core: true},
                    {title: 'Allele frequency Non-Finnish European', prop: 'Allele_frequency_genome_NFE_GnomADv3', core: true},
                    {title: 'Allele frequency Other', prop: 'Allele_frequency_genome_OTH_GnomADv3', core: true},
                    {title: 'Allele frequency South Asian', prop: 'Allele_frequency_genome_SAS_GnomADv3', core: true},
                    {title: 'Allele frequency Middle Eastern', prop: 'Allele_frequency_genome_MID_GnomADv3', core: true},
                    {title: 'Allele frequency Amish', prop: 'Allele_frequency_genome_AMI_GnomADv3', core: true}
                ]
            },
            {
                source: "GnomAD Exomes",
                chart: [
                    {title: 'Allele Frequency Charts (gnomAD Exomes)', prop: 'Allele_Frequency_Charts_Exome_GnomAD', replace: alleleFrequencyCharts, tableKey: false, dummy: true},
                ],
                data: [
                    {title: 'Total Allele frequency', prop: 'Allele_frequency_exome_GnomAD', core: true},
                    {title: 'Popmax Filtering Allele Frequency (95% confidence)', prop: 'faf95_popmax_exome_GnomAD', core: true},
                    {title: 'Allele frequency African', prop: 'Allele_frequency_exome_AFR_GnomAD', core: true},
                    {title: 'Allele frequency Latino', prop: 'Allele_frequency_exome_AMR_GnomAD', core: true},
                    {title: 'Allele frequency Ashkenazi Jewish', prop: 'Allele_frequency_exome_ASJ_GnomAD', core: true},
                    {title: 'Allele frequency East Asian', prop: 'Allele_frequency_exome_EAS_GnomAD', core: true},
                    {title: 'Allele frequency Finnish', prop: 'Allele_frequency_exome_FIN_GnomAD', core: true},
                    {title: 'Allele frequency Non-Finnish European', prop: 'Allele_frequency_exome_NFE_GnomAD', core: true},
                    {title: 'Allele frequency Other', prop: 'Allele_frequency_exome_OTH_GnomAD', core: true},
                    {title: 'Allele frequency South Asian', prop: 'Allele_frequency_exome_SAS_GnomAD', core: true},
                ]
...
const researchModeColumns = [
    ...
    {title: 'Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_GnomADv3'},
    {title: 'AFR Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_AFR_GnomADv3'},
    {title: 'AMR Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_AMR_GnomADv3'},
    {title: 'ASJ Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_ASJ_GnomADv3'},
    {title: 'EAS Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_EAS_GnomADv3'},
    {title: 'FIN Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_FIN_GnomADv3'},
    {title: 'NFE Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_NFE_GnomADv3'},
    {title: 'OTH Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_OTH_GnomADv3'},
    {title: 'SAS Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_SAS_GnomADv3'},
    {title: 'MID Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_MID_GnomADv3'},
    {title: 'AMI Allele frequency (gnomAD Genomes)', prop: 'Allele_frequency_genome_AMI_GnomADv3'},
