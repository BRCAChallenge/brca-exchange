...
const researchModeGroups = [
    ...
    {groupTitle: 'Allele Frequency Reference Sets', internalGroupName: 'Allele Frequency Reference Sets', innerCols: [
        ...
        {title: 'Allele count AFR (ExAC)', prop: 'Allele_count_AFR_ExAC', core: true},
        {title: 'Allele number AFR (ExAC)', prop: 'Allele_number_AFR_ExAC', core: true},
        {title: 'Allele frequency AFR (ExAC)', prop: 'Allele_frequency_AFR_ExAC', core: true},
        {title: 'Homozygous count AFR (ExAC)', prop: 'Homozygous_count_AFR_ExAC', core: true},
        {title: 'Allele count AMR (ExAC)', prop: 'Allele_count_AMR_ExAC', core: true},
        {title: 'Allele number AMR (ExAC)', prop: 'Allele_number_AMR_ExAC', core: true},
        {title: 'Allele frequency AMR (ExAC)', prop: 'Allele_frequency_AMR_ExAC', core: true},
        {title: 'Homozygous count AMR (ExAC)', prop: 'Homozygous_count_AMR_ExAC', core: true},
        {title: 'Allele count EAS (ExAC)', prop: 'Allele_count_EAS_ExAC', core: true},
        {title: 'Allele number EAS (ExAC)', prop: 'Allele_number_EAS_ExAC', core: true},
        {title: 'Allele frequency EAS (ExAC)', prop: 'Allele_frequency_EAS_ExAC', core: true},
        {title: 'Homozygous count EAS (ExAC)', prop: 'Homozygous_count_EAS_ExAC', core: true},
        {title: 'Allele count FIN (ExAC)', prop: 'Allele_count_FIN_ExAC', core: true},
        {title: 'Allele number FIN (ExAC)', prop: 'Allele_number_FIN_ExAC', core: true},
        {title: 'Allele frequency FIN (ExAC)', prop: 'Allele_frequency_FIN_ExAC', core: true},
        {title: 'Homozygous count FIN (ExAC)', prop: 'Homozygous_count_FIN_ExAC', core: true},
        {title: 'Allele count NFE (ExAC)', prop: 'Allele_count_NFE_ExAC', core: true},
        {title: 'Allele number NFE (ExAC)', prop: 'Allele_number_NFE_ExAC', core: true},
        {title: 'Allele frequency NFE (ExAC)', prop: 'Allele_frequency_NFE_ExAC', core: true},
        {title: 'Homozygous count NFE (ExAC)', prop: 'Homozygous_count_NFE_ExAC', core: true},
        {title: 'Allele count OTH (ExAC)', prop: 'Allele_count_OTH_ExAC', core: true},
        {title: 'Allele number OTH (ExAC)', prop: 'Allele_number_OTH_ExAC', core: true},
        {title: 'Allele frequency OTH (ExAC)', prop: 'Allele_frequency_OTH_ExAC', core: true},
        {title: 'Homozygous count OTH (ExAC)', prop: 'Homozygous_count_OTH_ExAC', core: true},
        {title: 'Allele count SAS (ExAC)', prop: 'Allele_count_SAS_ExAC', core: true},
        {title: 'Allele number SAS (ExAC)', prop: 'Allele_number_SAS_ExAC', core: true},
        {title: 'Allele frequency SAS (ExAC)', prop: 'Allele_frequency_SAS_ExAC', core: true},
        {title: 'Homozygous count SAS (ExAC)', prop: 'Homozygous_count_SAS_ExAC', core: true},
    ]},
...
const researchModeColumns = [
    ...
    {title: 'Allele frequency (ExAC)', prop: 'Allele_frequency_ExAC'},
    {title: 'Allele count AFR (ExAC)', prop: 'Allele_count_AFR_ExAC'},
    {title: 'Allele number AFR (ExAC)', prop: 'Allele_number_AFR_ExAC'},
    {title: 'Allele frequency AFR (ExAC)', prop: 'Allele_frequency_AFR_ExAC'},
    {title: 'Homozygous count AFR (ExAC)', prop: 'Homozygous_count_AFR_ExAC'},
    {title: 'Allele count AMR (ExAC)', prop: 'Allele_count_AMR_ExAC'},
    {title: 'Allele number AMR (ExAC)', prop: 'Allele_number_AMR_ExAC'},
    {title: 'Allele frequency AMR (ExAC)', prop: 'Allele_frequency_AMR_ExAC'},
    {title: 'Homozygous count AMR (ExAC)', prop: 'Homozygous_count_AMR_ExAC'},
    {title: 'Allele count EAS (ExAC)', prop: 'Allele_count_EAS_ExAC'},
    {title: 'Allele number EAS (ExAC)', prop: 'Allele_number_EAS_ExAC'},
    {title: 'Allele frequency EAS (ExAC)', prop: 'Allele_frequency_EAS_ExAC'},
    {title: 'Homozygous count EAS (ExAC)', prop: 'Homozygous_count_EAS_ExAC'},
    {title: 'Allele count FIN (ExAC)', prop: 'Allele_count_FIN_ExAC'},
    {title: 'Allele number FIN (ExAC)', prop: 'Allele_number_FIN_ExAC'},
    {title: 'Allele frequency FIN (ExAC)', prop: 'Allele_frequency_FIN_ExAC'},
    {title: 'Homozygous count FIN (ExAC)', prop: 'Homozygous_count_FIN_ExAC'},
    {title: 'Allele count NFE (ExAC)', prop: 'Allele_count_NFE_ExAC'},
    {title: 'Allele number NFE (ExAC)', prop: 'Allele_number_NFE_ExAC'},
    {title: 'Allele frequency NFE (ExAC)', prop: 'Allele_frequency_NFE_ExAC'},
    {title: 'Homozygous count NFE (ExAC)', prop: 'Homozygous_count_NFE_ExAC'},
    {title: 'Allele count OTH (ExAC)', prop: 'Allele_count_OTH_ExAC'},
    {title: 'Allele number OTH (ExAC)', prop: 'Allele_number_OTH_ExAC'},
    {title: 'Allele frequency OTH (ExAC)', prop: 'Allele_frequency_OTH_ExAC'},
    {title: 'Homozygous count OTH (ExAC)', prop: 'Homozygous_count_OTH_ExAC'},
    {title: 'Allele count SAS (ExAC)', prop: 'Allele_count_SAS_ExAC'},
    {title: 'Allele number SAS (ExAC)', prop: 'Allele_number_SAS_ExAC'},
    {title: 'Allele frequency SAS (ExAC)', prop: 'Allele_frequency_SAS_ExAC'},
    {title: 'Homozygous count SAS (ExAC)', prop: 'Homozygous_count_SAS_ExAC'},
