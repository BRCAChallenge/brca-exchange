...
const researchModeGroups = [
    ...
    {groupTitle: 'Allele Frequency Reference Sets', internalGroupName: 'Allele Frequency Reference Sets', innerCols: [
        ...
        {title: 'Allele frequency AFR (ExAC minus TCGA)', prop: 'Allele_frequency_AFR_ExAC', core: true},
        {title: 'Allele frequency AMR (ExAC minus TCGA)', prop: 'Allele_frequency_AMR_ExAC', core: true},
        {title: 'Allele frequency EAS (ExAC minus TCGA)', prop: 'Allele_frequency_EAS_ExAC', core: true},
        {title: 'Allele frequency FIN (ExAC minus TCGA)', prop: 'Allele_frequency_FIN_ExAC', core: true},
        {title: 'Allele frequency NFE (ExAC minus TCGA)', prop: 'Allele_frequency_NFE_ExAC', core: true},
        {title: 'Allele frequency OTH (ExAC minus TCGA)', prop: 'Allele_frequency_OTH_ExAC', core: true},
        {title: 'Allele frequency SAS (ExAC minus TCGA)', prop: 'Allele_frequency_SAS_ExAC', core: true},
    ]},

    {groupTitle: 'Allele Counts (ExAC minus TCGA)', internalGroupName: 'Allele Counts (ExAC minus TCGA)', innerCols: [
        {title: 'Allele count AFR', prop: 'Allele_count_AFR_ExAC', core: true},
        {title: 'Allele count AMR', prop: 'Allele_count_AMR_ExAC', core: true},
        {title: 'Allele count EAS', prop: 'Allele_count_EAS_ExAC', core: true},
        {title: 'Allele count FIN', prop: 'Allele_count_FIN_ExAC', core: true},
        {title: 'Allele count NFE', prop: 'Allele_count_NFE_ExAC', core: true},
        {title: 'Allele count OTH', prop: 'Allele_count_OTH_ExAC', core: true},
        {title: 'Allele count SAS', prop: 'Allele_count_SAS_ExAC', core: true},
    ]},
...
const researchModeColumns = [
    ...
    {title: 'Allele count AFR (ExAC minus TCGA)', prop: 'Allele_count_AFR_ExAC'},
    {title: 'Allele number AFR (ExAC minus TCGA)', prop: 'Allele_number_AFR_ExAC'},
    {title: 'Allele frequency AFR (ExAC minus TCGA)', prop: 'Allele_frequency_AFR_ExAC'},
    {title: 'Homozygous count AFR (ExAC minus TCGA)', prop: 'Homozygous_count_AFR_ExAC'},
    {title: 'Allele count AMR (ExAC minus TCGA)', prop: 'Allele_count_AMR_ExAC'},
    {title: 'Allele number AMR (ExAC minus TCGA)', prop: 'Allele_number_AMR_ExAC'},
    {title: 'Allele frequency AMR (ExAC minus TCGA)', prop: 'Allele_frequency_AMR_ExAC'},
    {title: 'Homozygous count AMR (ExAC minus TCGA)', prop: 'Homozygous_count_AMR_ExAC'},
    {title: 'Allele count EAS (ExAC minus TCGA)', prop: 'Allele_count_EAS_ExAC'},
    {title: 'Allele number EAS (ExAC minus TCGA)', prop: 'Allele_number_EAS_ExAC'},
    {title: 'Allele frequency EAS (ExAC minus TCGA)', prop: 'Allele_frequency_EAS_ExAC'},
    {title: 'Homozygous count EAS (ExAC minus TCGA)', prop: 'Homozygous_count_EAS_ExAC'},
    {title: 'Allele count FIN (ExAC minus TCGA)', prop: 'Allele_count_FIN_ExAC'},
    {title: 'Allele number FIN (ExAC minus TCGA)', prop: 'Allele_number_FIN_ExAC'},
    {title: 'Allele frequency FIN (ExAC minus TCGA)', prop: 'Allele_frequency_FIN_ExAC'},
    {title: 'Homozygous count FIN (ExAC minus TCGA)', prop: 'Homozygous_count_FIN_ExAC'},
    {title: 'Allele count NFE (ExAC minus TCGA)', prop: 'Allele_count_NFE_ExAC'},
    {title: 'Allele number NFE (ExAC minus TCGA)', prop: 'Allele_number_NFE_ExAC'},
    {title: 'Allele frequency NFE (ExAC minus TCGA)', prop: 'Allele_frequency_NFE_ExAC'},
    {title: 'Homozygous count NFE (ExAC minus TCGA)', prop: 'Homozygous_count_NFE_ExAC'},
    {title: 'Allele count OTH (ExAC minus TCGA)', prop: 'Allele_count_OTH_ExAC'},
    {title: 'Allele number OTH (ExAC minus TCGA)', prop: 'Allele_number_OTH_ExAC'},
    {title: 'Allele frequency OTH (ExAC minus TCGA)', prop: 'Allele_frequency_OTH_ExAC'},
    {title: 'Homozygous count OTH (ExAC minus TCGA)', prop: 'Homozygous_count_OTH_ExAC'},
    {title: 'Allele count SAS (ExAC minus TCGA)', prop: 'Allele_count_SAS_ExAC'},
