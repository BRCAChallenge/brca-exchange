                ...
                <Row>
                    <Col smOffset={1} sm={10}>
                        ...
                        <ol className="margin-ordered-list">
                            ...
                            <li>Get involved!  By partnering with advocacy groups such as <a href="https://www.facingourrisk.org/index.php" target="_blank" rel="noreferrer">FORCE</a> or <a href="https://lightcollective.org/" target="_blank" rel="noreferrer">The Light Collective</a>, you can help push for changes in access to care, privacy, and many other areas that benefit cancer patients and previvors everywhere.</li>
                        </ol>
                    </Col>
                </Row>
            </Grid>
