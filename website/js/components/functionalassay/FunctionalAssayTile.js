        ...
        return (
            <CollapsibleTile allEmpty={false} {...this.props}>
                <CollapsibleSection
                    ...
                    defaultVisible={true}
                >
                    <div className="subtile-container" style={{padding: 20, paddingTop: 10, paddingBottom: 0}}>
                        Results on functional classifications through saturation genome editing  by the Starita lab at the University of Washington (<a href="https://www.ncbi.nlm.nih.gov/pubmed/30209399">Findlay et al, Nature, 2018</a>).  Please see <a href="https://sge.gs.washington.edu/BRCA1/">their site</a> for further information.
                    </div>
