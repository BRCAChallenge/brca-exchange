...
var chartOptions1 = {
    ...
    series: [
        ...
        { name: "Likely Pathogenic", data: [ 0, 0 ] },
    ...
    componentWillMount: function() {
        backend.variantCounts().subscribe(
            resp => {
                ...
                chart1.series[3].setData([resp.brca1.likelyPathogenic, resp.brca2.likelyPathogenic], false);
                chart1.series[4].setData([resp.brca1.total - resp.brca1.pathogenic - resp.brca1.benign - resp.brca1.likelyBenign - resp.brca1.likelyPathogenic, resp.brca2.total - resp.brca2.pathogenic - resp.brca2.benign - resp.brca2.likelyBenign - resp.brca2.likelyPathogenic], true);
                chart2.series[0].setData([{ name: "Benign", y: resp.enigmaBenign }, { name: "Likely Benign", y: resp.enigmaLikelyBenign }, { name: "Pathogenic", y: resp.enigmaPathogenic }, { name: "Likely Pathogenic", y: resp.enigmaLikelyPathogenic }, { name: "Not Yet Reviewed", y: resp.total - resp.enigma }]);
                this.setState(resp);
            },
                ...
                <Row>
                    <Col smOffset={1} sm={10}>
                        ...
                        <ul>
                            ...
                            <li>By switching from the ‘summary view’ to the ‘detail view’, users may also explore information on variants that have not yet been reviewed by the expert panel. For these variants, the impact on disease risk has not yet been established.</li>
                        </ul>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <ul>
                                    ...
                                    <li>Variants expert-classified as likely pathogenic: {Number(this.state.enigmaLikelyPathogenic).toLocaleString()}</li>
