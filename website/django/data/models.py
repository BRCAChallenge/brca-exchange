...
class VariantGnomadData(models.Model):
    Variant = models.OneToOneField('Variant', primary_key=True)
...
def get_default_gnomad_variant_data():
    return Variant.objects.get(id=1)
...
def get_default_gnomad_report_data():
    return Report.objects.get(id=1)


class ReportGnomadData(models.Model):
    Report = models.OneToOneField('Report', primary_key=True)
