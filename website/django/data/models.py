...
class Variant(models.Model):
    ...
    Hg38_Start = models.TextField()
    Hg38_End = models.TextField()
    Hg37_Start = models.TextField()
    Hg37_End = models.TextField()
    Hg36_Start = models.TextField()
    Hg36_End = models.TextField()
