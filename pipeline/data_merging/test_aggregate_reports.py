...
TESTDATA_FILENAME = path.join(path.dirname(__file__), '1000_Genomesready.vcf')
...
class TestStringMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_file = TESTDATA_FILENAME

    def test_normalize_reports(self):
        file_reports = aggregate_reports.normalize_reports(self.test_file, self.columns)
